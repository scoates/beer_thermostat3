...
AVRDUDE_CONF_FILE = /usr/local/etc/avrdude.conf

ETHERNET = $(INSTALL_DIR)/libraries/Ethernet
ETHERNETSRCC = $(ETHERNET)/utility/w5100.c $(ETHERNET)/utility/socket.c
ETHERNETSRCCPP = $(ETHERNET)/Ethernet.cpp $(ETHERNET)/Server.cpp \
	$(ETHERNET)/Client.cpp
ETHERNETINC = -I$(ETHERNET) -I$(ETHERNET)/utility

LOCALSRCC = 
LOCALSRCCPP = webserver.cpp debug.cpp tempcontroller.cpp
